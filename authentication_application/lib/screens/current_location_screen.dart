...
class _CurrentLocationScreenState extends State<CurrentLocationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GoogleMap(initialCameraPosition: initialCameraPosition, markers: markers, zoomControlsEnabled: false, mapType: MapType.normal, onMapCreated: (GoogleMapController controller){
